'use strict';
app.controller('bookingController', ['$scope', 'localStorageService', function ($scope, localStorageService) {
    ...
    function init() {
       ...
       // $scope.CheckInDate = localStorageService.get("checkInDate");
      //  $scope.CheckOutDate = localStorageService.get("checkOutDate");
    ...
    $scope.BookDetail = function () {
        ...
        $.ajax({
            ...
            url: "http://localhost:53811/api/RoomAvailability",
            ...
            error: function (error) {
                ...
                alert("Some error occurred during operation");
    ...
    $scope.sendEmail = function () {
        ...
        $.ajax({
            ...
            url: "http://localhost:53811/api/Email",
            contentType: "application/json",
            success: function (exists) {
                $scope.Emailmodel = { FirstName: "", LastName: "", Contact: "", Room: "Single Non Ac", Price: "758 rs", Email: "" }
